...
VALUES ('Academic Committee', 'Oversee academic policies and curriculum development', 'username', CURRENT_DATE, 'username',
        CURRENT_DATE, RANDOM_UUID(), 'ACTIVE', 10, 'NEPALI', 1),
       ('Events Committee', 'Plan and organize all institutional events and seminars', 'username', CURRENT_DATE,
        'username',
        CURRENT_DATE, RANDOM_UUID(), 'ACTIVE', 10, 'ENGLISH', 2),
       ('Research and Development Committee', 'Promote research and innovation', 'username', CURRENT_DATE, 'username',
        CURRENT_DATE,
        RANDOM_UUID(), 'ACTIVE', 10, 'NEPALI', 3),
       ('Disciplinary Committee', 'Handle student and staff disciplinary issues', 'username', CURRENT_DATE, 'username',
        CURRENT_DATE,
        RANDOM_UUID(), 'ACTIVE', 10, 'NEPALI', 4),
       ('Student Welfare Committee', 'Addresse student concerns and well-being', 'username', CURRENT_DATE, 'username',
        CURRENT_DATE,
        RANDOM_UUID(), 'INACTIVE', 10, 'NEPALI', 5),
       ('IT and Infrastructure Committee', 'Manage IT resources and campus infrastructure', 'username', CURRENT_DATE,
        'username',
